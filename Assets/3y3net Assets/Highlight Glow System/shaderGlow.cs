...
public class shaderGlow : MonoBehaviour {
	...
	public enum allowedModes { userCallFunctions, onMouseEnter, alwaysOn};
	...
	[Range (0.15f,3.0f)]
	public float glowIntensity=3f; //Glow intensity on screen of the object
	[Range (0.5f,2.0f)]
	public float glowOpacity=2f; //Glow opacity on screen of the object
	public Color glowColor = Color.blue; //Glow color of the object
